...
> Historical investigation. The current implementation captures sender mesh/bone poses and uses passive remote renderers; see [multiplayer.md](multiplayer.md) for current behavior and validation. The proposals and missing pieces below describe the earlier research stage.
