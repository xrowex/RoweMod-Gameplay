...
local DEFAULT_PROPS = {
    ...
    stance = { "ActiveGrindType", "GrindType", "GrindStance", "CurrentGrind", "GrindName" },
    grab = { "GrabVariant", "IsGrabbing", "CurrentGrab", "GrabType", "ActiveGrab" },
    rail = { "CurrentSpline", "NextGrind", "CurrentRail", "GrindRail", "ActiveRail" },
    splineT = { "ElapsedGrindTime", "GrindDistance", "RailAlpha", "SplineDistance", "GrindAlpha" },
...
function M.local_pawn()
    -- Only the possessed pawn is authoritative. An arbitrary character search
    -- can select a remote ghost or a preview actor during respawn/travel.
